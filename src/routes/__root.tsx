...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shift & Leave Manager" },
      { name: "description", content: "Hospital staff scheduling, leave, and shift-change management." },
      { property: "og:title", content: "Shift & Leave Manager" },
      { property: "og:description", content: "Hospital staff scheduling, leave, and shift-change management." },
