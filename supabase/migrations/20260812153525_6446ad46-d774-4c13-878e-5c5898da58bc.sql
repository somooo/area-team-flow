ALTER TABLE public.leave_requests
  ADD COLUMN IF NOT EXISTS over_cap_override boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS over_cap_reason text,
  ADD COLUMN IF NOT EXISTS over_cap_by text;
...
DROP TRIGGER IF EXISTS trg_enforce_vacation_cap ON public.leave_requests;
CREATE TRIGGER trg_enforce_vacation_cap
  BEFORE INSERT OR UPDATE ON public.leave_requests
  FOR EACH ROW EXECUTE FUNCTION public.enforce_vacation_cap();